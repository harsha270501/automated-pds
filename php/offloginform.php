...
if(isset($_POST['login']))
    {
        ...
        $login="SELECT * FROM user_login WHERE  username= '$email' AND password = '$password' AND privileged='admin'";
...
<section id="register">
        <div class="container-fluid">
          <div class="row">
            ...
            ?>
            <a href="../html/tpdsdashboard.html"><input type="button" value="Continue" class="btn btn-primary " /></a>
        </div>
